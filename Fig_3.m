...
% cd ../../../../../Code
% 
% cd ../Network/Uniform/Mu_0_1/Eta_0_9/c1_0.1
% load ubin.dat;
% load vbin.dat;
% load UBF.dat;
% load VBF.dat;
...
% cd ../../../../../Code
% 
% cd ../Network/Uniform/Mu_0_1/Eta_0_8/c1_0.1
% load ubin.dat;
% load vbin.dat;
% load UBF.dat;
% load VBF.dat;
...
plot(Time,q(2,:),'--','Color',MC1(10,:),'LineWidth',size,'HandleVisibility','off')
